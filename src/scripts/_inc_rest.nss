...
float fUnusedCampDelay = ConvertMinutesToSeconds(15); // How many minutes until the camp cleanup check activates
float fUnusedCampMeters = 15.0; // How many meters away for a camp to be classed as abandoned
string sCampfire = "_camp_fire";
string sTent = "_camp_tent";
...
void ApplyFoodBuffs(object oPC, object oFood)
{
    ...
    if (DEBUG == TRUE)
    {
        ...
        SendDebugMessage("Food selected: "+sDebugName);
        SendDebugMessage("Food will last this many minutes: "+IntToString(iDuration));
        SendDebugMessage("Food will last this many seconds: "+FloatToString(fDuration));
    }
